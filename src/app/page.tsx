...
/* ─────────────── NAV ─────────────── */
function Navbar() {
  const links = ["Diamonds", "Gold", "Pearls", "Collections", "Bridal", "Contact"];
  return (
    <header className="w-full bg-warm-white border-b border-cream-dark/40 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 lg:px-10 py-4">
        <Link href="/" className="font-playfair text-xl font-bold tracking-wide text-text-dark">
          Mymy
        </Link>
        ...
        <div className="hidden md:flex items-center gap-5">
          {/* Search */}
          <button aria-label="Search" className="text-text-dark hover:text-gold transition-colors">
            <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
            </svg>
          </button>
          {/* Wishlist */}
          <button aria-label="Wishlist" className="text-text-dark hover:text-gold transition-colors">
            <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
            </svg>
          </button>
          {/* Cart */}
          <button aria-label="Cart" className="text-text-dark hover:text-gold transition-colors">
            <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
        ...
        {/* Mobile menu button */}
        <button className="md:hidden text-text-dark" aria-label="Menu">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 items-center py-12 lg:py-16 min-h-[85vh]">
        ...
        <div className="relative z-10 animate-fade-up">
          <h1 className="font-playfair text-[2.5rem] sm:text-[3rem] lg:text-[3.4rem] xl:text-[4rem] font-bold leading-[1.05] mb-6 uppercase">
            <span className="text-text-dark block">Crafted for</span>
            <span className="text-text-dark block">Eternity.</span>
            <span className="text-gold italic font-light block mt-1">Designed for</span>
            <span className="text-gold italic font-light block">Elegance.</span>
          </h1>
          <p className="font-montserrat text-[12px] sm:text-[13px] text-text-muted max-w-sm leading-relaxed mb-8">
            Explore our exclusive collections of certified diamonds, pure
            22K gold, and premium South Sea pearls, meticulously
            handcrafted for life&apos;s most precious moments.
          </p>
        ...
        <div className="hidden lg:block relative h-[540px] xl:h-[600px]">
          {/* Large circle image – ring on pedestal (top right) */}
          <div className="absolute -top-2 right-4 w-[260px] h-[260px] xl:w-[300px] xl:h-[300px] rounded-full overflow-hidden shadow-2xl z-10 animate-float ring-4 ring-cream-dark/20">
            <Image
          ...
          {/* Model portrait (center-left, overlapping) */}
          <div className="absolute top-[130px] left-[5%] w-[210px] h-[310px] xl:w-[230px] xl:h-[340px] rounded-2xl overflow-hidden shadow-2xl z-20 animate-float-slow">
            <Image
          ...
          {/* White product card (bottom right) */}
          <div className="absolute bottom-8 right-[8%] w-[190px] h-[190px] xl:w-[210px] xl:h-[210px] rounded-2xl bg-white shadow-xl z-10 flex flex-col items-start justify-end p-5 animate-fade-up delay-300">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {craftsmanshipItems.map((c) => (
            <div key={c.title} className="flex flex-col items-center gap-3 transition-transform duration-300 hover:-translate-y-1">
              <div className="w-20 h-20 rounded-full bg-cream flex items-center justify-center transition-transform duration-300 group-hover:scale-105">
                {c.icon}
              </div>
...
const specialCollections = [
  {
    ...
    img: "https://images.unsplash.com/photo-1596944924616-7b38e7cfac36?w=500&h=600&fit=crop",
  },
  {
    name: "Royal Gold",
    img: "https://images.unsplash.com/photo-1610694955371-d4a3e0ce4b52?w=500&h=600&fit=crop",
  },
  {
    name: "Pearl Signature",
    img: "https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=500&h=600&fit=crop",
  },
  {
    name: "Modern Fusion Jewelry",
    ...
    <footer className="w-full bg-text-dark text-cream-dark py-16">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* Brand */}
          <div>
            <h3 className="font-playfair text-2xl font-bold text-warm-white mb-4">Mymy</h3>
            <p className="font-montserrat text-sm leading-relaxed text-cream-dark/70 max-w-xs">
              Crafting timeless elegance through exquisitely crafted gemstone jewelry,
              an trusted industry partner. With a tradition built on the foundation of
              purity, quality and unmatched artisanship.
            </p>
            <div className="flex gap-4 mt-6">
              {/* Instagram */}
              <a href="#" className="text-cream-dark/60 hover:text-gold transition-colors" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About Us", "Diamond Collections", "Gold Jewelry", "Pearl Jewelry", "Bridal Collections"].map((l) => (
                <li key={l}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Contact Us", "Shipping & Returns", "Warranty Information", "Ring Size Guide", "Care Instructions"].map((l) => (
                <li key={l}>
                  <Link href="#" className="font-montserrat text-sm text-cream-dark/60 hover:text-gold transition-colors">
                    {l}
                  </Link>
        ...
        <div className="border-t border-cream-dark/20 mt-12 pt-8 text-center">
          <p className="font-montserrat text-xs text-cream-dark/50">
            © 2026 Mymy Jewelry. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
