...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Luxury gold + brown palette matching the site
      const palette = [
        { r: 184, g: 134, b: 11  }, // #b8860b  — main gold
        { r: 212, g: 168, b: 67  }, // #d4a843  — light gold
        { r: 139, g: 105, b: 20  }, // #8b6914  — dark gold
        { r: 196, g: 169, b: 90  }, // #c4a95a  — soft gold
        { r: 107, g: 93,  b: 82  }, // #6b5d52  — muted brown
        { r: 44,  g: 36,  b: 32  }, // #2c2420  — deep brown
